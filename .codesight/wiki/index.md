...
_Generated 2026-09-20 — re-run `npx codesight --wiki` if the codebase has changed._
...
- Models: **10**
- Components: **114**
- Env vars: **7** required, **23** with defaults
...
---
_Last compiled: 2026-09-20 · 8 articles · [codesight](https://github.com/Houseofmvps/codesight)_